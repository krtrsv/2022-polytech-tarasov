...
TEST_CASE("Elements can be inserted") {
  ...
  ll.insert(0, 8);
  CHECK(ll == LinkedList{8, 1, 2, 9, 3, 4, 5});

  ll.insert(7, 7);
  CHECK(ll == LinkedList{8, 1, 2, 9, 3, 4, 5, 7});

  REQUIRE(ll.size() == 8);
}

TEST_CASE("Elements can be removed") {
  LinkedList ll{8, 1, 2, 9, 3, 4, 5, 7};

  ll.remove(3);
  CHECK(ll == LinkedList{8, 1, 2, 3, 4, 5, 7});

  ll.remove(0);
  CHECK(ll == LinkedList{1, 2, 3, 4, 5, 7});
